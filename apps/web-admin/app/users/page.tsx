...
const mockUsers: User[] = [
  {
    id: "user-1",
    tenantId: "ethiopia-addis",
    authProviderId: "admin@afribrok.et",
    role: "admin",
    emailHash: "admin-email-hash",
    kycStatus: "verified",
    mfaEnabled: true,
    createdAt: "2024-01-01T00:00:00Z",
    updatedAt: "2024-10-20T10:30:00Z",
    lastLogin: "2024-10-21T04:15:00Z",
    status: "active"
  },
  {
    id: "user-2",
    tenantId: "ethiopia-addis",
    authProviderId: "alemayehu@example.com",
    role: "broker",
    emailHash: "alemayehu-email-hash",
    phoneHash: "alemayehu-phone-hash",
    kycStatus: "verified",
    mfaEnabled: false,
  ...
  },
  {
    id: "user-3",
    tenantId: "ethiopia-addis",
    authProviderId: "sara.m@primeprops.et",
    role: "broker",
    emailHash: "sara-email-hash",
    phoneHash: "sara-phone-hash",
    kycStatus: "pending",
    mfaEnabled: false,
    createdAt: "2024-01-19T14:20:00Z",
    updatedAt: "2024-10-18T09:15:00Z",
    lastLogin: "2024-10-18T12:30:00Z",
  ...
  },
  {
    id: "user-4",
    tenantId: "ethiopia-addis",
    authProviderId: "inspector@afribrok.et",
    role: "inspector",
    emailHash: "inspector-email-hash",
    kycStatus: "verified",
    mfaEnabled: true,
    createdAt: "2024-02-01T00:00:00Z",
    updatedAt: "2024-10-15T08:00:00Z",
    lastLogin: "2024-10-19T09:30:00Z",
    status: "active"
  },
  {
    id: "user-5",
    tenantId: "ethiopia-addis",
    authProviderId: "customer@example.com",
    role: "individual_seller",
    emailHash: "customer-email-hash",
    phoneHash: "customer-phone-hash",
    kycStatus: "pending",
    mfaEnabled: false,
    createdAt: "2024-10-10T15:20:00Z",
    updatedAt: "2024-10-20T11:45:00Z",
    lastLogin: "2024-10-20T14:00:00Z",
    status: "active"
  }
];
...
export default function UsersPage() {
  ...
  const handleAddUser = () => {
    ...
    const newUser: User = {
      id: `user-${Date.now()}`,
      tenantId: "ethiopia-addis",
      authProviderId: newUserForm.email,
      role: newUserForm.role,
      emailHash: `${newUserForm.email}-hash`,
      phoneHash: undefined,
      kycStatus: "pending",
      ...
      broker: newUserForm.role === 'broker' ? {
        id: `broker-${Date.now()}`,
        status: "pending",
        licenseDocs: { businessName: newUserForm.businessName || newUserForm.email }
      } : undefined
    };
    ...
    alert(`User ${newUserForm.email} has been created successfully!`);
  };
...
function UserRow({ user }: { user: User }) {
  ...
  const handleToggleStatus = () => {
    ...
    alert(`User status will be changed to: ${newStatus}`);
  };

  const handleToggleMFA = () => {
    const newMFA = !user.mfaEnabled;
    alert(`MFA will be ${newMFA ? 'enabled' : 'disabled'} for this user`);
  };
