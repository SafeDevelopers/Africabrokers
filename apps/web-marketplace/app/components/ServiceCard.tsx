    ...
    <div className="group relative rounded-2xl border-2 border-gray-100 bg-white p-6 shadow-lg transition-all hover:-translate-y-1 hover:border-indigo-500/30 hover:shadow-xl">
      ...
      <div className="flex items-center gap-3">
        <Link
          href={href}
          onClick={handleClick}
          className="inline-flex items-center gap-2 rounded-lg border-2 border-indigo-600 bg-transparent px-4 py-2 text-sm font-semibold text-indigo-600 transition-all hover:bg-indigo-50 hover:border-indigo-700 hover:text-indigo-700 active:scale-95"
        >
          Get Started
